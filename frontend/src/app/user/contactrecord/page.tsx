...
// Columns definition (without actions)
const columns = [
...
// Visible columns without actions
const INITIAL_VISIBLE_COLUMNS = ["firstName", "middleName", "lastName", "company", "contactNo", "email", "designation"];
